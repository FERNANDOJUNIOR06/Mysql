...
('X-Burguer', 15.90),
('X-Salada', 16.50),
('Refrigerante 350ml', 6.00),
('Batata Frita Média', 9.50),
('Milkshake Chocolate 500ml', 12.00),
('Combo X-Tudo + Refri', 28.90),
('Cheeseburguer Vegano', 17.80);
...
INSERT INTO Pedidos (idCliente, idProduto, status) VALUES
(1, 1, 'Entregue'),          -- Augusto comprou X-Burguer
(2, 3, 'Pronto'),            -- Bruno comprou Refrigerante
(3, 4, 'Em preparo'),        -- Fernando comprou Batata Frita
(4, 2, 'Entregue'),          -- Henrique comprou X-Salada
(5, 6, 'Cancelado'),         -- Natan comprou Combo X-Tudo + Refri
(6, 5, 'Entregue'),          -- Pedro comprou Milkshake
(7, 7, 'Em preparo'),        -- Daniel comprou Cheeseburguer Vegano
(1, 6, 'Entregue'),          -- Augusto fez outro pedido: Combo
(3, 2, 'Pronto');            -- Fernando fez outro pedido: X-Salada
